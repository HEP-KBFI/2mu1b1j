...
{
public:
RecoJetSelectorBtag_2mu1b1j(int era, int index, bool debug);
...
typedef ParticleCollectionSelector<RecoJet, RecoJetSelectorBtagMedium_2mu1b1j> RecoJetCollectionSelectorBtagMedium_2mu1b1j;
